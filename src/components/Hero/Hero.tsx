      ...
      <div className="relative z-10 h-full max-w-full w-full mx-auto px-6 flex flex-col md:flex-row items-start md:items-center md:justify-between gap-8 text-white">
        <div className="md:w-2/3 text-center md:text-left md:pr-8">
          ...
          <p className="mt-6 max-w-2xl md:max-w-full text-base md:text-xl text-white/90">
            Built for beginners to advanced. Whether you're a day to day grinder
            looking to improve your daily life, a desk athlete working from home
            and just needing to move, or an all-out high-performer, this is the
            place for you. Programs, tips & tricks, fitness and nutrition tools,
            coaching and more—all in one place.
          </p>
